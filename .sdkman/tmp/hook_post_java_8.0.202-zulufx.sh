...
function __sdkman_post_installation_hook {
    __sdkman_echo_debug "A Linux post-install hook was found for Java 8.0.202-zulufx."
    ...
    echo ""
    echo "Repackaging Java 8.0.202-zulufx..."
...
function __sdkman_validate_binary_input {
    if ! tar tzf "$1" &> /dev/null; then
        ...
        echo ""
        echo "Can not install java 8.0.202-zulufx at this time..."
        return 1
    fi
}
