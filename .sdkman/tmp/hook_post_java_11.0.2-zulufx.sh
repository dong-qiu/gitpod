...
function __sdkman_post_installation_hook {
    __sdkman_echo_debug "A Linux post-install hook was found for Java 11.0.2-zulufx."
    ...
    echo ""
    echo "Repackaging Java 11.0.2-zulufx..."
...
function __sdkman_validate_binary_input {
    if ! tar tzf "$1" &> /dev/null; then
        ...
        echo ""
        echo "Can not install java 11.0.2-zulufx at this time..."
        return 1
    fi
}
